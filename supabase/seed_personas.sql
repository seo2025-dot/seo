...
-- Requiere schema.sql con las actualizaciones 002 (fotos), 003 (universidad, colegio, estatura, pareja ideal) y 004 (valores y pareja ideal estructurada).
...
update public.profiles set display_name = 'Emilia Vintimilla',
  ...
  interests = array['amigos']::text[], zones = array['Barrio Histórico', 'Las Lomas']::text[], relations = array['pareja', 'amistad']::text[], lifestyle = array['Creativo', 'Lector', 'Espiritual']::text[], core_values = array['Honestidad', 'Familia', 'Creatividad']::text[],
...
on conflict (id) do nothing;
update public.user_private set birth_date = '1991-05-19', ideal_partner = 'Alguien de carácter tranquilo y ambición sana, que trabaje con propósito y no necesite aparentar. Emprendedor o con espíritu de construir, con estudios universitarios, lector, que disfrute del deporte, del buen café y de las caminatas por Cumbayá los fines de semana. Que hable con claridad, respete mis tiempos y quiera formar una familia y una comunidad en la que ambos crezcamos.', ideal_values = array['Ambición', 'Honestidad', 'Crecimiento personal']::text[], ideal_lifestyle = array['Emprendedor', 'Deportista', 'Lector']::text[] where user_id = '00000000-0000-4000-8000-000000000102';
update public.profiles set display_name = 'Mariana Larrea',
  ...
  interests = array['amigos', 'inversor']::text[], zones = array['Zona Norte', 'Valle Alto']::text[], relations = array['pareja', 'socios']::text[], lifestyle = array['Emprendedor', 'Foodie', 'Lector']::text[], core_values = array['Ambición', 'Crecimiento personal', 'Sostenibilidad']::text[],
...
update public.profiles set display_name = 'Génesis Villamar',
  ...
  interests = array['amigos', 'anfitrion']::text[], zones = array['Puerto Nuevo', 'Centro']::text[], relations = array['pareja', 'amistad']::text[], lifestyle = array['Deportista', 'Viajero', 'Familiar']::text[], core_values = array['Familia', 'Aventura', 'Sentido del humor']::text[],
...
update public.profiles set display_name = 'Sebastián Astudillo',
  ...
  interests = array['amigos']::text[], zones = array['Las Lomas', 'Centro']::text[], relations = array['pareja', 'amistad']::text[], lifestyle = array['Creativo', 'Espiritual', 'Lector']::text[], core_values = array['Creatividad', 'Fe', 'Honestidad']::text[],
...
update public.profiles set display_name = 'Andrés Terán',
  ...
  interests = array['comprador', 'inversor']::text[], zones = array['Valle Alto', 'Zona Norte']::text[], relations = array['pareja', 'socios']::text[], lifestyle = array['Deportista', 'Emprendedor', 'Casero']::text[], core_values = array['Familia', 'Estabilidad', 'Honestidad']::text[],
